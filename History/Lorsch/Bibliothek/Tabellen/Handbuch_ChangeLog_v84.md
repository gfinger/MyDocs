...
## v74 / Materialisierung v7-45 – Pal. lat. 822

- Ausgangstabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-44.md`.
- Neue Tabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-45.md`.
- BL-Grundlage: `bav_pal_lat_822.pdf`.
- Audit-Datei: `materialisierung_v7-45_pal_lat_822_aenderungen.tsv`.

| ID | Bereich | Änderung | Umfang |
| --- | --- | --- | ---: |
| UM-v7-45-001 | `LHS0230 / Pal. lat. 822` | `TXT0251` wurde nach BL präzisiert: Autor/Titel auf Rufinus Aquileiensis und Eusebius Caesariensis, Seiten `1r-175v`, Siegel `bav_pal_lat_822`. | 1 Zeile |
| UM-v7-45-002 | Klassifikation | `Buchgattung` von `Kirchengeschichte` auf `Geschichtswerk` normalisiert; `Kirchengeschichte` als Untergattung und Thema geführt. | 1 Zeile |
| UM-v7-45-003 | Bemerkungen | Prolog, Translatio I-IX, Continuatio X-XI, mehrere Hände, angelsächsisch geschulter Schreiber, Lorsch/Älterer Lorscher Stil, Ergänzung Bll. 96-97 sowie Textfamilie/Vorlage/Canterbury- und Leidener-Glossar-Bezug dokumentiert. | 1 Zeile |
...
## v75 / Materialisierung v7-46 – Bodleian Library, MS. Laud. misc. 276

- Ausgangstabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-45.md`.
- Neue Tabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-46.md`.
- BL-Grundlage: `bodleian_mslaudmisc276.pdf`.
- Audit-Datei: `materialisierung_v7-46_bodleian_mslaudmisc276_aenderungen.tsv`.

| ID | Bereich | Änderung | Umfang |
| --- | --- | --- | ---: |
| UM-v7-46-001 | `LHS0099 / MS. Laud. misc. 276` | Der bisherige Platzhalter `TXT0107 / Gregor von Nazianz / Tractatus` wurde nach BL in vier gattungsfähige Einträge aufgespalten. | 1 → 4 Zeilen |
| UM-v7-46-002 | `TXT0107-01` | Gregorius Nazianzenus; Rufinus Aquileiensis, `Orationes IX a Rufino Aquileiensi Latine versae`, 1r/v-70v; 81r-85r, als `Homilien / Dogmatik / Griechische Patristik` geführt. | 1 Zeile |
| UM-v7-46-003 | `TXT0107-02` | Gregorius Iliberritanus, `De fide (recensio II)`, 71r-80r, als `Fachtext / Traktat / Dogmatik / Lateinische Patristik` geführt. | 1 Zeile |
| UM-v7-46-004 | `TXT0107-03` | Ps.-Gregorius Iliberritanus (Ps.-Damasus), `Fides Romanorum`, 80r/v, als `Fachtext / Glaubensbekenntnis / Dogmatik / Lateinische Patristik` geführt. | 1 Zeile |
| UM-v7-46-005 | `TXT0107-04` | Alcuinus (?), `Sequentia „Summi regis archangele Michael“`, 85r, als neumierter Sequenz-Nachtrag aufgenommen. | 1 Zeile |
...
## v76 / Materialisierung v7-47 – Cod. Guelf. 18.22 Aug. 4°

- Ausgangstabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-46.md`.
- Neue Tabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-47.md`.
- BL-Grundlage: `hab_mss18-22-aug-4f.pdf`.
- Audit-Datei: `materialisierung_v7-47_hab_mss18-22-aug-4f_aenderungen.tsv`.

| ID | Bereich | Änderung | Umfang |
| --- | --- | --- | ---: |
| UM-v7-47-001 | `LHS0309 / Cod. Guelf. 18.22 Aug. 4°` | Der bisherige Platzhalter `TXT0339 / Evangelia` wurde nach BL in zehn gattungsfähige Einträge aufgespalten. | 1 → 10 Zeilen |
| UM-v7-47-002 | `TXT0339-01` bis `TXT0339-05` | Drei Hieronymus-Prologe, eusebianische Kanontafeln und Matthäus-Argumentum wurden als exegetischer Prolog- und Kanontafelapparat erfasst. | 5 Zeilen |
| UM-v7-47-003 | `TXT0339-06` bis `TXT0339-07` | Haupt-Capitulare und Nachtrags-Capitulare wurden als `Liturgischer Text / Evangeliencapitulare` getrennt geführt. | 2 Zeilen |
| UM-v7-47-004 | `TXT0339-08` bis `TXT0339-09` | Zwei rhythmische Gedichte zu den eusebianischen Kanones wurden als `Dichtung / Merkgedicht` aufgenommen. | 2 Zeilen |
| UM-v7-47-005 | `TXT0339-10` | Der Evangelientext wurde als `Evangelia IV cum argumentis` präzisiert. | 1 Zeile |
| UM-v7-47-006 | `Faszikel II / Bll. 116-143` | `Apocalypsis cum glossa` nicht in die Haupttabelle aufgenommen, da BL Entstehungsort unbekannt, 12./13. Jh. und Provenienz Paderborn nennt. | 0 Zeilen |
...
## v77 / Materialisierung v7-48 – Vatikan, BAV, Pal. lat. 202

- Ausgangstabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-47.md`.
- Neue Tabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-48.md`.
- BL-Grundlage: `bav_pal_lat_202.pdf`.
- Audit-Datei: `materialisierung_v7-48_pal_lat_202_aenderungen.tsv`.

| ID | Bereich | Änderung | Umfang |
| --- | --- | --- | ---: |
| UM-v7-48-001 | `LHS0159 / Pal. lat. 202` | `TXT0177 / Augustinus / De trinitate` wurde nach BL präzisiert: Siegel `bav_pal_lat_202`, Seiten `1r-181va`, Bemerkungen zu Breviculus, Prolog, Textverlust und Überlieferungsstellung ergänzt. | 1 Zeile |
| UM-v7-48-002 | Provenienz / Lorsch-Bezug | Deutsch-angelsächsisches Gebiet um 800 und Lorsch (?) wurden differenziert dokumentiert; Provenienz Lorsch, früh möglicher Lorscher Gebrauch, Lorscher `hd`/`hl`-Verweiszeichen und HÄSE 2002, Nr. 83 wurden eingetragen. | 1 Zeile |
| UM-v7-48-003 | Klassifikation | Keine neue Split-Entscheidung: Capitula/Breviculus und Aug. ep. 174 bleiben als Teil der De-trinitate-Überlieferung in den Bemerkungen; Klassifikation bleibt `Fachtext / Traktat / Theologie / Lateinische Patristik`. | 1 Zeile |
...
## v78 / Materialisierung v7-49 – Vatikan, BAV, Pal. lat. 285

- Ausgangstabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-48.md`.
- Neue Tabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-49.md`.
- BL-Grundlage: `bav_pal_lat_285.pdf`.
- Audit-Datei: `materialisierung_v7-49_pal_lat_285_aenderungen.tsv`.

| ID | Bereich | Änderung | Umfang |
| --- | --- | --- | ---: |
| UM-v7-49-001 | `LHS0199 / Pal. lat. 285` | `TXT0219 / Beda Venerabilis / In Canticum Canticorum` wurde nach BL präzisiert: Siegel `bav_pal_lat_285`, Seiten `1r-150v`, Titel `In Cantica Canticorum allegorica expositio`, Bemerkungen zu Prolog, Capitula, Canticum-Text, libri I-V und liber VI aus Gregors Opuscula ergänzt. | 1 Zeile |
| UM-v7-49-002 | Provenienz / Lorsch-Bezug | Lorsch, 1. Hälfte 9. Jh., Jüngerer Lorscher Stil, mehrere Hände, Lorscher Besitzvermerk auf Iv, Korrekturen mit `hd`/`hl`-Verweiszeichen und HÄSE 2002, Nr. 195, vgl. Nr. 442 (Cb17), wurden dokumentiert. | 1 Zeile |
| UM-v7-49-003 | Klassifikation | Keine neue Split-Entscheidung: Prologus, Capitula, biblischer Canticum-Text und liber VI bleiben als Bestandteile der Beda-Überlieferung in den Bemerkungen; Klassifikation bleibt `Bibelkommentar / Exegese / Angelsächsische Gelehrsamkeit`. | 1 Zeile |
...
## v79 / Materialisierung v7-50 – Oxford, Bodleian Library, MS. Laud. lat. 104 und Erlangen, UB, Ms. 2112/7

- Ausgangstabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-49.md`.
- Neue Tabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-50.md`.
- BL-Grundlage: `uben_ms2112-7.pdf`.
- Audit-Datei: `materialisierung_v7-50_uben_ms2112-7_aenderungen.tsv`.

| ID | Bereich | Änderung | Umfang |
| --- | --- | --- | ---: |
| UM-v7-50-001 | `LHS0083 / MS. Laud. lat. 104; Ms. 2112/7` | `TXT0091 / Sidonius Apollinaris / Epistulae` wurde nach BL in `TXT0091-01` Epistulae und `TXT0091-02` Carmina-Fragment gesplittet. | 2 Zeilen |
| UM-v7-50-002 | Provenienz / Lorsch-Bezug | Entstehungsort Hofschule Ludwigs d. Fr. (?) bzw. Hofschule Ludwigs d. Fr. nach Bischoff, Lorsch nach Lehmann, Oxf./Erlang. zusammengehörig, unsichere Lorsch/Eberbach-Provenienz und HÄSE 2002, Nr. 304 wurden in den Bemerkungen dokumentiert. | 2 Zeilen |
| UM-v7-50-003 | Klassifikation | `Epistulae` auf `Briefe / Briefliteratur / Spätantike Gelehrsamkeit` normiert; `Carmina` als `Dichtung / Carmina / Dichtung / Spätantike Gelehrsamkeit` neu geführt. | 2 Zeilen |
...
## v81 / Materialisierung v7-52 – Vatikan, BAV, Pal. lat. 276

- Ausgangstabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-51.md`.
- Neue Tabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-52.md`.
- BL-Grundlage: `bav_pal_lat_276.pdf`.
- Audit-Datei: `materialisierung_v7-52_pal_lat_276_aenderungen.tsv`.

| ID | Bereich | Änderung | Umfang |
| --- | --- | --- | ---: |
| UM-v7-52-001 | `LHS0192 / Pal. lat. 276` | Der bisherige Platzhalter `TXT0211 / Isidor von Sevilla / Quaestiones in Vetus Testamentum (In Reges)` wurde nach BL in vier Einträge gesplittet: anonyme `Explanatio in librum II Regum`, Isidors `Quaestiones in Vetus Testamentum`, Isidors `Versus seu Carmina` und Bedas `In libros Regum quaestiones XXX`. | 4 Zeilen |
| UM-v7-52-002 | Provenienz / Lorsch-Bezug | Entstehungsort Weißenburg, 1. Hälfte 9. Jh.; Provenienz Lorsch; spätmittelalterlicher Lorscher Besitzvermerk; HÄSE 2002, Nr. 200b zum Beda-Teil wurden in den Bemerkungen dokumentiert. | 4 Zeilen |
| UM-v7-52-003 | Klassifikation | Isidor und Beda als `Bibelexegese / Quaestiones` klassifiziert; anonyme Erklärung zu II Regum als `Bibelkommentar`; Isidors Verse als `Dichtung / Carmina`. | 4 Zeilen |
...
## v82 / Materialisierung v7-53 – Vatikan, BAV, Pal. lat. 273

- Ausgangstabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-52.md`.
- Neue Tabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-53.md`.
- BL-Grundlage: `bav_pal_lat_273.pdf`.
- Audit-Datei: `materialisierung_v7-53_pal_lat_273_aenderungen.tsv`.

| ID | Bereich | Änderung | Umfang |
| --- | --- | --- | ---: |
| UM-v7-53-001 | `LHS0191 / Pal. lat. 273` | Die bereits gesplitteten Einträge `TXT0210-01` bis `TXT0210-05` wurden nach BL präzisiert. | 5 Zeilen |
| UM-v7-53-002 | Provenienz / Lorsch-Bezug | Ende 12. Jh., Entstehungsort unbekannt, Provenienz `Lorsch (?)` bzw. `Ladenburg (?)`, mögliche Dalberg-Auffindung in Lorsch und Katalogbezug nur als `Hs. gleichen Inhalts` HÄSE 2002, Nr. 303 wurden in den Bemerkungen dokumentiert. | 5 Zeilen |
| UM-v7-53-003 | Klassifikation | Marbodus wurde als hochmittelalterlicher rhetorischer Schultext `Fachtext / Rhetorik / Rhetorik / Mittelalterliche Gelehrsamkeit` präzisiert; Ps.-Ausonius als Sentenzen, die anonymen Zusatztexte als Literaturkunde bzw. Kosmographie. | 5 Zeilen |
...
## v83 / Tabelle v7-54 – Überlieferungslinien differenziert (2026-08-18)

- Forschungstabelle auf `v7-54` materialisiert.
- `Mittelalterliche Gelehrsamkeit` wurde in den betroffenen Zeilen auf präzisere Werte verteilt.
- `Hochmittelalter` wurde als bloßer Epochenwert aufgelöst.
- `Humanismus` wurde zu `Humanistische Gelehrsamkeit` normiert.
- Hugo von St. Victor wird als `Hochmittelalterliche Gelehrsamkeit` geführt, nicht als Scholastik.
- Kirchenrechtliche Sammlungen wurden gemäß bestehender Norm bei `Christlicher Kanon` belassen.
- Validierung: 520 Datenzeilen, 13 Spalten, 0 fehlerhafte Zeilen, 0 doppelte TXT-IDs, 12 palimpsestierte Einträge, 0 verbotene Sammlung-Buchgattungen.


## v84 / Forschungstabelle v7-55 – Pal. lat. 213

- `TXT0182` wurde in drei Einträge aufgelöst: Sermones Ps.-Augustini/Caesarius, Epistula Iacobi mit Prolog, Epistula I Petri mit Prolog.
- `TXT0183` wurde als Phocas grammaticus, `Ars de nomine et verbo (Fragment)`, präzisiert.
- `TXT0184-01` und `TXT0184-02` wurden für Pal. lat. 213 korrigiert: `Categoriae decem` und `De decem praeceptis et decem plagis`; falsches Siegel aus vorheriger Zuordnung entfernt.
- `TXT0185` wurde in `TXT0185-01` und `TXT0185-02` aufgelöst: Ps.-Augustinus, `De essentia divinitatis`, und Gennadius Massiliensis, `Liber ecclesiasticorum dogmatum`.
- Ergebnis: +3 Datenzeilen gegenüber v7-54.
