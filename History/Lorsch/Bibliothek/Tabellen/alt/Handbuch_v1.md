# Handbuch_v1 zur Forschungstabelle Lorsch

**Datenbasis:** `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v6.md`
...
- `Evangelistar` und `Perikopenbuch` harmonisieren; als Buchgattung empfiehlt sich `Perikopenbuch`, wenn die liturgische Lesungsfunktion gemeint ist.
...
| Bibelauslegung | 2 | Oberbegriff für exegetische Texte, die einen biblischen Text erklären, ohne bereits als Kommentar, Homilie oder Glosse enger bestimmt zu sein. | Beibehalten. |
| Bibelbezogene Quaestionen | 1 | Frage-Antwort- oder Problemexegese zu biblischen Stoffen. | Prüfen, ob dauerhaft als eigene Gattung nötig; sonst zu „Bibelauslegung“ oder „Bibelkommentar“ ziehen. |
| Bibelexegese | 1 | Allgemeiner Gattungsbegriff für Auslegung biblischer Texte. | Als Oberbegriff brauchbar; bei konkretem Kommentar besser „Bibelkommentar“ verwenden. |
| Bibelglossen | 2 | Stellenbezogene, meist kurze Erläuterungen zu Bibeltexten, Prologen oder biblischen Namen. | Beibehalten. |
| Bibelglossen / Kommentar | 1 | Mischform zwischen kurzen Bibelglossen und fortlaufender Kommentierung. | Bei Endredaktion nach dominanter Form entweder „Bibelglossen“ oder „Bibelkommentar“. |
| Bibelglossen / liturgisch-theologischer Exzerpt | 1 | Bibelglossenbestand mit eingelagertem liturgisch-theologischem Exzerpt. | Besser „Bibelglossen“ als Buchgattung; liturgisch-theologischen Einschub in Werktyp/Bemerkungen erfassen. |
| Bibelkommentar | 31 | Fortlaufende oder abschnittsweise Auslegung eines biblischen Buches. | Beibehalten. |
| Bibelkommentar / Homilien | 1 | Biblische Auslegung in homiletischer Form oder mit Predigtcharakter. | Nur behalten, wenn die Form wirklich doppeldeutig ist; sonst „Bibelkommentar“ oder „Homilien“. |
| Bibelkommentar / Predigten | 2 | Biblische Auslegung, deren Überlieferungsform zwischen Kommentar und Predigt steht. | Nur behalten, wenn Kommentar und Predigt gleichrangig sind; sonst auf eine Gattung reduzieren. |
...
| Homilien | 11 | Mehrere Predigten oder Homilien eines Autors oder Traditionskreises. | Beibehalten. |
| Homilien / Bibelauslegung | 1 | Predigtförmige Auslegung biblischer Texte. | Nur behalten, wenn beide Komponenten gleichrangig sind; sonst auf den dominanten Gattungsbegriff normieren. |
| Homiliensammlung | 3 | Sammlung von Homilien verschiedener oder eines Autors. | Beibehalten. |
...
| Lehrschrift | 10 | Didaktische Abhandlung zu einem Fachgebiet. | Beibehalten. |
...
| Liturgik | 2 | Lehr- oder Erklärungstext zu Gottesdienst, Ritus und kirchlicher Ordnung. | Beibehalten. |
| Liturgische Notiz | 1 | Kurze Notiz mit liturgischem Inhalt oder liturgischer Deutung. | Beibehalten. |
| Liturgische Ordnung | 1 | Ordnungstext, der Ablauf oder Struktur eines liturgischen Vollzugs regelt. | Beibehalten. |
...
| Liturgisches Buch | 12 | Handschriftlicher Textbestand für liturgischen Gebrauch. | Beibehalten. |
...
| Messbuch | 2 | Buch für die Messliturgie. | Als spezifische liturgische Buchgattung beibehalten; nicht auf „Liturgisches Buch“ zurückverallgemeinern. |
| Messerklärung | 1 | Auslegung des Messritus und seiner Zeichen. | Beibehalten. |
...
| Pontifikale | 1 | Liturgisches Buch für bischöfliche Amtshandlungen. | Als spezifische liturgische Buchgattung beibehalten; nicht auf „Liturgisches Buch“ zurückverallgemeinern. |
...
| Sakramentar | 2 | Liturgisches Buch mit priesterlichen Gebeten der Messe und anderer Feiern. | Als spezifische liturgische Buchgattung beibehalten; nicht auf „Liturgisches Buch“ zurückverallgemeinern. |
...
| Sammlung | 2 | Allgemeiner Sammelbegriff für mehrere zusammengehörige Texte oder Exzerpte. | Wenn möglich präzisieren: Anthologie, Florilegium, Homiliensammlung, Kanonessammlung usw. |
...
| Traktat / Bibelauslegung | 2 | Traktat mit exegetischer Funktion oder biblischer Auslegung. | Nach Schwerpunkt entscheiden: „Traktat“ oder „Bibelkommentar“. |
