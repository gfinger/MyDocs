...
## Materialisierung v7-51: Oxford, Bodleian Library, MS. Laud. misc. 159 / LHS0096

### Quelle und Zuordnung

BL beschreibt MS. Laud. misc. 159 als Lorscher Codex der 1. Hälfte bzw. des 2. Viertels bis Mitte des 9. Jh. im Jüngeren Lorscher Stil. Der Codex enthält Wigbodus, Beda und Wigbods Octateuch-Kommentar; die Provenienz führt von Lorsch nach Eberbach. Die Bischoff-Zuordnung in der Primärtabelle ist `LHS0096 / Laud. misc. 159 / Wigbod, In Octateuchum`. BL nennt als Katalogbezug vorsichtig HÄSE 2002, Nr. 11 und 425; nach Gorman ist diese Handschrift unter Nr. 11 verzeichnet, während Nr. 425 verloren sei, nach Bischoff könnten sich Nr. 11 und Nr. 425 eventuell auf dieselbe Handschrift beziehen.

### Tabellenänderung

Der bisherige Platzhalter `TXT0104 / LHS0096 / Wigbod / In Octateuchum` wurde nach BL in drei gattungsfähige Einträge aufgespalten:

- `TXT0104-01`: Wigbodus (?) (Ps.-Beda; Ps.-Ambrosius), `Explanatio sex dierum`, 1ra-16vb.
- `TXT0104-02`: Beda Venerabilis, `Hexaemeron seu In principium Genesis (lib. I,1,1-2,3 = recensio Ia)`, 16vb-29ra.
- `TXT0104-03`: Wigbodus, `Commentarium in Octateuchum`, 29ra/rb-135rb.

### Klassifikationsentscheidungen

- Alle drei Texte werden als `Bibelkommentar / Exegese` geführt, weil sie als Genesis- bzw. Octateuch-Auslegung in der Handschrift erscheinen.
- Die beiden Wigbod-Texte werden wegen der Wigbod-Zuschreibung bzw. Gormans Lokalisierungsüberlegung der `Karolingischen Gelehrsamkeit` zugeordnet.
- Bedas Hexaemeron-Auszug wird als `Angelsächsische Gelehrsamkeit` geführt; die recensio Ia und die Praefatio an Acca bleiben in den Bemerkungen sichtbar.
- Der Octateuch-Kommentar wird nicht in acht einzelne biblische Bücher aufgespalten, da BL ihn als zusammengehöriges `Commentarium in Octateuchum` beschreibt; die enthaltenen Abschnitte von Genesis bis Ruth und der Textverlust nach Bl. 39 werden in den Bemerkungen dokumentiert.
- `palimpsestiert` bleibt leer.
