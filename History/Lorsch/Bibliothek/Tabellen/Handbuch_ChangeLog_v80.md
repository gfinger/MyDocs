...
## v80 / Materialisierung v7-51 – Oxford, Bodleian Library, MS. Laud. misc. 159

- Ausgangstabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-50.md`.
- Neue Tabelle: `lorsch-forschung_gesamttabelle_102-135_arbeitsstand_v7-51.md`.
- BL-Grundlage: `bodleian_mslaudmisc159.pdf`.
- Audit-Datei: `materialisierung_v7-51_bodleian_mslaudmisc159_aenderungen.tsv`.

| ID | Bereich | Änderung | Umfang |
| --- | --- | --- | ---: |
| UM-v7-51-001 | `LHS0096 / MS. Laud. misc. 159` | `TXT0104 / Wigbod / In Octateuchum` wurde nach BL in drei gattungsfähige Einträge aufgespalten. | 1 → 3 Zeilen |
| UM-v7-51-002 | `TXT0104-01` | Wigbodus (?) (Ps.-Beda; Ps.-Ambrosius), `Explanatio sex dierum`, 1ra-16vb, als `Bibelkommentar / Exegese / Karolingische Gelehrsamkeit` geführt. | 1 Zeile |
| UM-v7-51-003 | `TXT0104-02` | Beda Venerabilis, `Hexaemeron seu In principium Genesis (lib. I,1,1-2,3 = recensio Ia)`, 16vb-29ra, als `Bibelkommentar / Exegese / Angelsächsische Gelehrsamkeit` geführt. | 1 Zeile |
| UM-v7-51-004 | `TXT0104-03` | Wigbodus, `Commentarium in Octateuchum`, 29ra/rb-135rb, als `Bibelkommentar / Exegese / Karolingische Gelehrsamkeit` geführt; Abschnittsumfang Genesis bis Ruth und Textverlust nach Bl. 39 in den Bemerkungen dokumentiert. | 1 Zeile |
| UM-v7-51-005 | Katalogbezug | HÄSE 2002, Nr. 11 und 425 nach BL vorsichtig dokumentiert; Gorman/Bischoff-Differenz in den Bemerkungen festgehalten. | 3 Zeilen |
