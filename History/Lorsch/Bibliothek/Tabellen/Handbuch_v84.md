...
## Materialisierung v7-49: Vatikan, Biblioteca Apostolica Vaticana, Pal. lat. 285 / LHS0199

### Quelle und Zuordnung

BL beschreibt Pal. lat. 285 als Beda-Codex aus Lorsch, 1. Hälfte des 9. Jh., im Jüngeren Lorscher Stil. Der Codex enthält Bedas `In Cantica Canticorum allegorica expositio`; die Provenienz wird durch den Lorscher Besitzvermerk auf Iv und die spätere Palatina-Überlieferung gestützt. Der karolingische Katalogbezug ist HÄSE 2002, Nr. 195, mit Verweis auf Nr. 442 (Cb17). Die Bischoff-Zuordnung in der Primärtabelle ist `LHS0199 / Pal. lat. 285 / Beda, In Cant.`.

### Tabellenänderung

Der bisherige Platzhalter `TXT0219 / LHS0199 / Beda Venerabilis / In Canticum Canticorum` wurde nicht aufgespalten, sondern nach BL präzisiert:

- `TXT0219`: Beda Venerabilis, `In Cantica Canticorum allegorica expositio`, 1r-150v.

### Klassifikationsentscheidungen

- Die Klassifikation bleibt `Bibelkommentar / Exegese / Angelsächsische Gelehrsamkeit`.
- Prologus contra Iulianum Aeclanensem (1r-11r), Capitula (11r/v-13r), der eingebundene Canticum-canticorum-Text (13r/v-17r), libri I-V der Expositio und liber VI aus Gregors Opuscula werden als Bestandteile der Beda-Überlieferung in den Bemerkungen dokumentiert, nicht als eigene TXT-Zeilen geführt.
- `Allegorica expositio` bleibt im Titel; `Allegorese` wird nicht als Untergattung geführt.
- `palimpsestiert` bleibt leer.
...
## Materialisierung v7-50: Oxford, Bodleian Library, MS. Laud. lat. 104 und Erlangen, UB, Ms. 2112/7 / LHS0083

### Quelle und Zuordnung

BL beschreibt Oxford, Bodleian Library, MS. Laud. lat. 104 und Erlangen, Universitätsbibliothek Erlangen-Nürnberg, Ms. 2112/7 als zusammengehörige Sidonius-Überlieferung. Der Hauptcodex in Oxford enthält die unvollständigen `Epistulae`; das Erlanger Doppelblattfragment enthält Stücke aus den `Carmina`. Als Entstehungsort werden Hofschule Ludwigs d. Fr. (?) bzw. Hofschule Ludwigs d. Fr. nach Bischoff und Lorsch nach Lehmann genannt; die Datierung liegt in der 1. Hälfte des 9. Jh. bzw. ca. 814-830. Die Lorscher Provenienz ist für Oxford nicht gesichert und verläuft wahrscheinlich über Eberbach; der karolingische Katalogbezug ist HÄSE 2002, Nr. 304 (`Liber epistularum Sidonii ad diversos`), mit BL-Hinweis auf Bischoff 1989. Die Bischoff-Zuordnung in der Primärtabelle ist `LHS0083 / Laud. lat. 104 / Sidonius Apoll., Epp.`.

### Tabellenänderung

Der bisherige Platzhalter `TXT0091 / LHS0083 / Sidonius Apollinaris / Epistulae` wurde nach BL in zwei Zeilen gesplittet:

- `TXT0091-01`: C. Sollius Apollinaris Sidonius, `Epistulae (unvollständig)`, Oxf. 1v/2r-96v, 103r/v, 97r-102v.
- `TXT0091-02`: C. Sollius Apollinaris Sidonius, `Carmina (Fragment)`, Erlang. [1]r-[2]v.

### Klassifikationsentscheidungen

- Die `Epistulae` werden als `Briefe / Briefliteratur / Spätantike Gelehrsamkeit` geführt. Die bisherige Überlieferungslinie `Lateinische Patristik` wurde für Sidonius in diesem literarisch-spätantiken Kontext auf `Spätantike Gelehrsamkeit` normiert.
- Die `Carmina` werden als `Dichtung / Carmina / Dichtung / Spätantike Gelehrsamkeit` geführt.
- Der Lorsch-Bezug bleibt `ja`, wird aber in den Bemerkungen ausdrücklich vorsichtig begründet: Entstehung nach Bischoff eher Hofschule Ludwigs d. Fr., nicht sicher Lorsch; Lorsch/Eberbach-Provenienz unsicher; karolingischer Katalogeintrag HÄSE 2002, Nr. 304.
- `palimpsestiert` bleibt leer.
...
- Grundlage: `bav_pal_lat_276.pdf`.
- Handschrift: Vatikan, BAV, Pal. lat. 276 / `LHS0192`.
- Entstehung: Weißenburg, 1. Hälfte 9. Jh.; Provenienz Lorsch, später Heidelberg.
- Karolingischer Katalogbezug: zu Beda, `In libros Regum quaestiones XXX`, vgl. HÄSE 2002, Nr. 200b.

### Materialisierung

Der bisherige Platzhalter `TXT0211 / Isidor von Sevilla / Quaestiones in Vetus Testamentum (In Reges)` wurde durch vier Einträge ersetzt:

| TXT-ID | Autor | Titel | Seiten | Klassifikation |
| --- | --- | --- | --- | --- |
| `TXT0211-01` | Anonymus | `Explanatio in librum II Regum (II Rg 23,8-39)` | `[1]r` | `Bibelkommentar / — / Königsbücher / Frühmittelalterliche Gelehrsamkeit` |
| `TXT0211-02` | Isidor von Sevilla | `Quaestiones in Vetus Testamentum seu Mysticorum expositiones sacramentorum (in I-IV Rg, Esr, Mcc) cum appendice ad libros Regum` | `2r-39v` | `Bibelexegese / Quaestiones / Altes Testament / Spätantike Gelehrsamkeit` |
| `TXT0211-03` | Isidor von Sevilla | `Versus seu Carmina` | `39v-40v` | `Dichtung / Carmina / Dichtung / Spätantike Gelehrsamkeit` |
| `TXT0211-04` | Beda Venerabilis | `In libros Regum quaestiones XXX` | `41r-65r` | `Bibelexegese / Quaestiones / Königsbücher / Angelsächsische Gelehrsamkeit` |

### Klassifikatorische Entscheidung

- Isidors exegetischer Haupttext bleibt wegen der Werkform als `Bibelexegese / Quaestiones` normiert.
- Bedas `Quaestiones XXX` wird analog als `Bibelexegese / Quaestiones` geführt, mit Überlieferungslinie `Angelsächsische Gelehrsamkeit`.
- Die anonymen Erläuterungen zu II Regum werden als `Bibelkommentar` behandelt.
- Isidors `Versus seu Carmina` werden nicht als Beiwerk versteckt, sondern als eigene Dichtungsüberlieferung erfasst.
...
Pal. lat. 273 war bereits in v7-15 gesplittet; v7-53 präzisiert die fünf Einträge nach der BL-Textbeschreibung. Die Handschrift selbst ist nach BL Ende 12. Jh., Entstehungsort unbekannt; die Provenienz ist `Lorsch (?)` bzw. `Ladenburg (?)`, und der karolingische Katalogbezug ist nur als `Hs. gleichen Inhalts` zu HÄSE 2002, Nr. 303 formuliert. Der Lorsch-Bezug bleibt daher in der Tabelle positiv, aber in den Bemerkungen ausdrücklich als unsicher bzw. über Parallel-/Inhaltsnachweis abgesichert dokumentiert.

### Normierungsentscheidungen

- `TXT0210-01` wird als `Dichtung / Sentenzen / Ethik / Spätantike Gelehrsamkeit` präzisiert.
- `TXT0210-02` wird als Cassiodors `Variae (libb. I-VII; unvollständig)` geführt; die Zugehörigkeit zur zweiten Klasse der Variae-Überlieferung wird in den Bemerkungen dokumentiert.
- `TXT0210-03` wird als hochmittelalterlicher rhetorischer Schultext `Fachtext / Rhetorik / Rhetorik / Mittelalterliche Gelehrsamkeit` geführt; dies ist eine bewusste Präzisierung gegenüber einer zu allgemeinen Artes-liberales-Normierung, weil Marbodus Redonensis hier als Autor des 11./12. Jh. und nicht als bloßer spätantiker Artes-Überlieferungsträger relevant ist.
- `TXT0210-04` bleibt `Fachtext / Literaturkunde`; der Cento-Bezug zu Homer, Vergil und Eudoxia Augusta wurde präzisiert.
- `TXT0210-05` bleibt `Fachtext / Kosmographie`; das Wind-/Erdkreis-Schaubild und die nichtlateinischen Begriffe neben dem Schaubild wurden ergänzt.
...
## v83 – Differenzierung mittelalterlicher Überlieferungslinien (2026-08-18)

Die bisher zu groben Werte `Mittelalterliche Gelehrsamkeit`, `Hochmittelalter` und `Humanismus` werden in der Forschungstabelle differenziert bzw. normiert. Ziel ist, hochmittelalterliche, scholastische und humanistische Wissensformen sichtbar zu machen, ohne alle mittelalterlichen Nachträge pauschal in eine einzige Linie zu stellen.

### Neue bzw. präzisierte Normwerte

| Normwert | Verwendung |
|---|---|
| `Hochmittelalterliche Gelehrsamkeit` | 11.–12. Jh.; Schul-, Kloster-, Kompilations-, Rhetorik- und Kosmographie-Texte, wenn keine engere Linie trägt. |
| `Scholastische Gelehrsamkeit` | Nur bei eindeutig scholastischen Textformen bzw. im Kontext der systematischen Aristoteles-Rezeption; derzeit nicht neu materialisiert. |
| `Humanistische Gelehrsamkeit` | 14.–15. Jh.; humanistische Brieflehre, Briefe, Reden, klassische Philologie und Renaissance-Rezeption. |
| `Spätmittelalterliche Gelehrsamkeit` | Nicht-humanistische gelehrte Texte des 14./15. Jh., besonders wenn weder Humanismus noch Scholastik sachlich passt. |
| `Hochmittelalterliche Schriftlichkeit` | Urkunden-/Verwaltungs- oder Memorialschriftlichkeit des Hochmittelalters, wenn `Gelehrsamkeit` als Linie zu eng wäre. |

Hugo von St. Victor wird als `Hochmittelalterliche Gelehrsamkeit` geführt, nicht als `Scholastische Gelehrsamkeit`. Scholastik wird enger verstanden und nicht schon bei jedem Schulautor des 12. Jahrhunderts angesetzt. Kirchenrechtliche Sammlungen bleiben, entsprechend der bestehenden Normierung, bei `Christlicher Kanon`.

### Materialisierte Änderungen in v7-54

| Gruppe | Änderung | Anzahl |
|---|---|---:|
| alte Sammelwerte | `Mittelalterliche Gelehrsamkeit` aufgelöst | 7 |
| alter Epochenwert | `Hochmittelalter` aufgelöst | 5 |
| alter Epochenwert | `Humanismus` zu `Humanistische Gelehrsamkeit` | 4 |
| Gesamt | geänderte Zeilen | 16 |

Validierung v7-54: 520 Datenzeilen, 13 Spalten, keine fehlerhaften Tabellenzeilen, keine doppelten `TXT-ID`, `palimpsestiert = ja` weiterhin 12, keine `Sammlung`/`Sammelhandschrift` in `Buchgattung`.


## Version v84 – Pal. lat. 213 / LHS0164–LHS0167

Die Auswertung von Vatikan, BAV, Pal. lat. 213 wurde in die Forschungstabelle übernommen. Der heutige Codex besteht aus drei Faszikeln und einem Fragment; die Tabellenführung folgt deshalb den LHS-Einheiten:

- LHS0164: Faszikel I, Lorsch, 1. Hälfte 9. Jh.; pseudo-augustinische bzw. caesarianische Sermones sowie Iacobus und I Petrus mit Prologen.
- LHS0165: Fragment Bl. 21, Phocas grammaticus, Ars de nomine et verbo; 9.–10. Jh.; Lorsch (?) / Augsburg / Heidelberg.
- LHS0166: Faszikel II, Categoriae decem / Ps.-Augustinus mit Scholien, Prolog und Alkuin-Versen; dazu De decem praeceptis et decem plagis.
- LHS0167: Faszikel III, Lorsch, 1. Hälfte 9. Jh.; Ps.-Augustinus, De essentia divinitatis, und Gennadius, Liber ecclesiasticorum dogmatum.

Die frühere Fehlzuordnung der Siegel-/Inhaltsdaten bei LHS0166 wurde korrigiert: die einschlägigen Zeilen führen nun `bav_pal_lat_213`, nicht mehr eine fremde Münchener Signatur.
